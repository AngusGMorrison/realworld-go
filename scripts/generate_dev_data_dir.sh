...
echo "Generating development data directory..."
...
echo "Development JWT key generated. This is gitignored by default. DO NOT COMMIT THIS KEY."

echo "Data dependencies generated successfully at '${REALWORLD_HOST_DATA_DIR}!'"
